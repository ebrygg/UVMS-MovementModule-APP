...
public class DateUtilTest extends TransactionalTests {
	...
	@Test
    @OperateOnDeployment("movementservice")
	public void testParseToUTCDate() throws ParseException { //To UTC Date is somewhat misleading, the function simply parses a string into a date.
		//This test is basically a carbon copy of testGetDateFromString() since the only difference between them is the output.
